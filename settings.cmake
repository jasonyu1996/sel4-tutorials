...
if(${TUT_BOARD} STREQUAL "pc")
    ...
    elseif(${TUT_ARCH} STREQUAL "riscv64")
...
elseif(${TUT_BOARD} STREQUAL "qemu-riscv-virt")
    set(KernelArch "riscv64" CACHE STRING "" FORCE)
    set(KernelSel4Arch "riscv64" CACHE STRING "" FORCE)
    set(KernelPlatform "qemu-riscv-virt" CACHE STRING "" FORCE)
else()
